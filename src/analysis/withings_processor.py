...
class WithingsProcessor:
    ...
    def process_data(self, raw_data: Dict[str, Any], start_date: datetime, end_date: datetime) -> Dict[str, pd.DataFrame]:
        ...
        if "weight" in raw_data:
            result["weight"] = self.process_weight_data(raw_data["weight"], start_date, end_date)
            
        return result
    
    def process_weight_data(self, weight_data: Dict[str, Any], start_date: datetime, end_date: datetime) -> pd.DataFrame:

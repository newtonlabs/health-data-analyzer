...
class HevyProcessor:
    ...
    def process_workouts(self, workouts_data: Dict[str, Any]) -> Tuple[pd.DataFrame, pd.DataFrame]:
        ...
        for i, workout in enumerate(workouts):
            ...
            for exercise in exercises:
                ...
                workout_date_str = start_datetime.strftime("%m-%d") if start_datetime else ""
                ...
                exercise_records.append({
                    ...
                    "workout_date": start_datetime.date() if start_datetime else None,  # Full date object
    ...
    def save_processed_data(self, workout_df: pd.DataFrame, exercise_df: pd.DataFrame, date: datetime) -> Tuple[str, str]:
        ...
        date_str = DateUtils.format_date(date, DateFormat.STANDARD)

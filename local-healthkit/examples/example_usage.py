#!/usr/bin/env python3
"""
Example usage of the restored Local HealthKit package.
This script demonstrates basic usage for Whoop, Withings, OneDrive, Hevy, and Oura APIs
using the restored implementation with service abstraction.
"""
...
# Import the services from the local_healthkit package
...
def test_hevy_service():
    ...
    try:
        ...
        try:
            from local_healthkit import HevyClient
...
def test_oura_service():
    ...
    try:
        ...
        # Also test personal info endpoint if available
        try:
            client = service.oura_client
            if hasattr(client, 'get_personal_info'):
        ...
        # Check if it's an authentication issue
        try:
            from local_healthkit import OuraClient
...
def main():
    ...
    print("🚀 Local HealthKit Package - Restored Implementation")
    print("=" * 60)
    print()
    ...
    if success_count > 0:
        ...
        print("✅ Local HealthKit package restoration successful!")
    else:
